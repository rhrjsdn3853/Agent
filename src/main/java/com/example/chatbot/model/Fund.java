...
/**
 * Represents a Fund Product with detailed attributes, including a URL for more details.
 */
public class Fund {
    ...
    public Fund(String productName, String productType, String riskLevel, String return1Month,
                ...
                String managementCompany, String productSummary, String cluster, String url) {
